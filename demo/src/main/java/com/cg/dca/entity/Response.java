	...
	public class Response {
		...
		private int respId;
			...
			private int accuracy;	// Likes on Response increase accuracy
			  ...
			  @JoinColumn(name = "feedId", referencedColumnName = "feedId") private Feed
			  feed;
		public int getRespId() {
				...
				public void setAccuracy(int accuracy) {
				  ...
				  this.dev = dev; } public Feed getFeed() { return feed; } public void
				  setFeed(Feed feed) { this.feed = feed; }
